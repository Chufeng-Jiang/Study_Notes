...
Download address: https://soft.3dmgame.com/down/299928.html -> click "普通下载" （general download）

Registration Information：

```c++
User Name: damie
Reg Code: ANE0N-LZ7HA-9Y4IT-DBKA3-K7NIQ
```

![image-20240519074934724](assets/image-20240519074934724.png)



# Attention: 

Be sure to use the revised "apue.h"
...
# 1. How to get the authority code?
...
# 2. Installation and use of bsd library

```bash
sudo apt-get install libbsd-dev
```

## 2.1 How to use bsd library？
```bash
